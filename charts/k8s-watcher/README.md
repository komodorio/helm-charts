...
| `watcher.resources.customAPIGroups`               | A whitelist of allowed resources to read from cluster - each array element should be in the structure: { apiGroups, resources, verbs }                                                                                      | `[]`                              |
