...
| `watcher.resources.customReadAPIGroups`               | A whitelist of allowed resources to read from cluster - each array element should a string which represents the group name                                                                                    | `[]`                              |
