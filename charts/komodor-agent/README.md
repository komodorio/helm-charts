...
![AppVersion: 0.2.178](https://img.shields.io/badge/AppVersion-0.2.178-informational?style=flat-square)
...
| capabilities.crActions | bool | `true` | Allow komodor to create and manage custom resources in the cluster |
