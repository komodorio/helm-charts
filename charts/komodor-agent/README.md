...
![AppVersion: 0.2.148](https://img.shields.io/badge/AppVersion-0.2.148-informational?style=flat-square)
...
| telegrafImageVersion | string | `"v2.0.1-alpine"` | Telegraf version to be used |
| telegrafWindowsImageVersion | string | `"v2.0.1-windows"` | Telegraf version to be used for windows |
...
| components.komodorDaemon.metrics.sidecar | object | `{"enabled":true}` | Configure the telegraf-init sidecar containerAdd commentMore actions |
...
| components.komodorDaemonWindows.metrics.sidecar | object | `{"enabled":true}` | Configure the telegraf-init sidecar containerAdd commentMore actions |
