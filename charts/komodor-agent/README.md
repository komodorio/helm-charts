...
![AppVersion: 0.2.224](https://img.shields.io/badge/AppVersion-0.2.224-informational?style=flat-square)
...
| admissionControllerVersion | string | `"0.1.69"` | Admission controller version to be used |
