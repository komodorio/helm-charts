...
| telegrafImageVersion | string | `"v1.34.4-build1-alpine"` | Telegraf version to be used |
| telegrafWindowsImageVersion | string | `"v1.34.4-build1-windows"` | Telegraf version to be used for windows |
...
| components.komodorMetrics.metrics.image | object | `{"name":"telegraf","tag":"v1.34.4-build1-alpine"}` | Override the komodor agent metrics image name or tag. |
...
| components.komodorDaemon.metrics | object | `{"dcgm":true,"extraEnvVars":[],"image":{"name":"telegraf","tag":"v1.34.4-build1-alpine"},"quiet":false,"resources":{"limits":{"cpu":1,"memory":"1Gi"},"requests":{"cpu":0.1,"memory":"384Mi"}}}` | Configure the komodor daemon metrics components |
| components.komodorDaemon.metrics.image | object | `{"name":"telegraf","tag":"v1.34.4-build1-alpine"}` | Override the komodor agent metrics image name or tag. |
...
| components.komodorDaemonWindows.metrics | object | `{"extraEnvVars":[],"image":{"name":"telegraf-windows","tag":"v1.34.4-build1-windows"},"quiet":false,"resources":{"limits":{"cpu":1,"memory":"1Gi"},"requests":{"cpu":0.1,"memory":"384Mi"}}}` | Configure the komodor daemon metrics components |
| components.komodorDaemonWindows.metrics.image | object | `{"name":"telegraf-windows","tag":"v1.34.4-build1-windows"}` | Override the komodor agent metrics image name or tag. |
