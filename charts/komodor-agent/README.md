...
![AppVersion: 0.2.235](https://img.shields.io/badge/AppVersion-0.2.235-informational?style=flat-square)
...
| admissionControllerVersion | string | `"0.1.73"` | Admission controller version to be used |
