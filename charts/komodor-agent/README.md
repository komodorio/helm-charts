...
| capabilities.klaudiaIntegrationSync | object | See sub-values | Sync MCPIntegration and Skill CRs to the Klaudia API |
| capabilities.klaudiaIntegrationSync.enabled | bool | `false` | Enable MCPIntegration and Skill CR sync controller |
