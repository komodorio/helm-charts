...
| components.admissionController.affinity.nodeAntiAffinity | object | `{}` | Set node anti-affinity for the komodor admission controller deployment |
