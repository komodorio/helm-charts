...
| components.komodorDaemon.opentelemetry.image | object | `{"name":"634375685434.dkr.ecr.us-east-1.amazonaws.com/otelcol-komodor","tag":"35a47f77"}` | Override the OpenTelemetry collector image name or tag. |
