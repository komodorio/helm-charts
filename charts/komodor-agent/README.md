...
| components.komodorDaemon.opentelemetry.image | object | `{"name":"634375685434.dkr.ecr.us-east-1.amazonaws.com/otelcol-komodor","tag":"1b72f179"}` | Override the OpenTelemetry collector image name or tag. |
