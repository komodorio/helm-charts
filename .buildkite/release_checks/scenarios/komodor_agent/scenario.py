...
class KomodorAgentScenario(Scenario):
    ...
    def __init__(self, kubeconfig):
        ...
        self.agents = [{"clusterName": CLUSTER_NAME, "agentVersion": rc_chart_version, "name": "komodor-agent-rc", "extra_args": ""},
                       {"clusterName": "komodor-agent-ga", "agentVersion": "", "name": "komodor-agent-ga", "extra_args": "--set capabilities.events.create=false"}]

    def generate_installation_cmd(self, cluster_name, chart_version, name, extra_args):
